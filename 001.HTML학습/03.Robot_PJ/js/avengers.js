...
window.addEventListener('wheel',(e)=>{
    ...
    if(e.wheelDelta<0){
        ...
        .setAttribute('src','https://www.youtube.com/embed/Ko2NWhXI9e8?autoplay=1');
    } //////////// if ////////////////
    else{ // d위로 올라올때 - 멈춤
        qs('.trailer-box iframe')
        .setAttribute('src','https://www.youtube.com/embed/Ko2NWhXI9e8');
    } ////////////// else ///////////
...
// 4. 로딩후 2초 후 avengers박스에 클래스 on 넣기
setTimeout(() => {
