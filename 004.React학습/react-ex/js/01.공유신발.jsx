...
function MainComponent(){
    ...
    // 3. 선택아이템 고유번호 상태관리변수
    const [setItem,setSelItem] = React.useState(0);
    // 4. JS 효과적용여부 상태관리변수
    ...
    console.log('컴포넌트 그냥구역:',
        ...
        // 의존성이 다수일경우 [] 배열형태의 옵션에
        // 콤마로 연결하여 등록해준다!

        
        // 랜더링 후 화면출력전 상태
        React.useLayoutEffect(()=>{
            console.log('useLayoutEffect 구역:');
        // 버튼을 display:none
        // $('.btn-gong').hide();
        });
    ...
    const chgSubView = (num,idx) => {
        ...
        <React.Fragment>
            ...
            <section>
                <h2>{
                dataNum?'효진이는 오늘도 예쁩니다!':
                '공유는 오늘도 멋찝니다!'}</h2>
                {/* 이미지 */}
                <div className="img-box">
                <img src={dataNum?
                "./images/gallery/효진.jpg":
                    "./images/vans/gongyoo.jpg"} 
                    alt={dataNum?"예쁜 효진":"멋진공유"} />
                </div>
            </section>
            {/* 3. 데이터 변경 버튼 */}
